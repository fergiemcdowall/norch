var Norch = module.exports = function(options) {
  ...
  this.program = require('commander')
    ...
    .parse(process.argv);
  this.siOptions = {};
  this.siOptions['logSilent'] = this.program.logSilent;
  this.siOptions['indexPath'] = this.program.indexPath;
  this.siOptions['logLevel'] = this.program.logLevel;
  this.norchOptions = {}
  this.norchOptions['port'] = this.program.port;
  this.norchOptions['hostname'] = this.program.hostname;
  for (var k in options) {
    this.siOptions[k] = options[k];
    this.norchOptions[k] = options[k];
  }
//  this.si = require('search-index')(this.siOptions);
  var SearchIndex = require('search-index');
  this.si = new SearchIndex(this.siOptions);
  this.morgan = require('morgan');
  this.app = new this.express();
  this.app.listen(this.norchOptions.port);
