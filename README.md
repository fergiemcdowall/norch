...
Norch is essentially an http wrapper around [search-index](https://www.npmjs.com/package/search-index). See the [API docs](https://github.com/fergiemcdowall/norch/blob/master/doc/API.md)
